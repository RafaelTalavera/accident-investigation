...
public class Case2 {
    ...
    public String case2(Event event) {
        ...
        if (
            ...
            //metodo
                !event.getEntry()                         // false: Antiguedad
            ...
            jsonHipotesis.put("Personales", "Factores personales: \n" +
                    "Según la información ingresada, el accidentado tiene una antigüedad menor a 6 meses en el puesto y cuenta con un historial de accidentes previos. Con esta combinación, se puede inferir que la persona aún no tenía la preparación necesaria y, además, es propensa a conductas riesgosas.");
