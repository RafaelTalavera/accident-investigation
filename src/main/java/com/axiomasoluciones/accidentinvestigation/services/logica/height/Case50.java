...
import static com.axiomasoluciones.accidentinvestigation.models.entity.util.persistencia.Weather.HUMEDAD_ALTA;
...
public class Case50 {
    ...
    public String case50(Event event) {
        ...
        if (
            ...
            return "Caso 50 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
