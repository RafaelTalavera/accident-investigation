...
public class Case48 {
    ...
    public String case48(Event event) {
        ...
        if (
            ...
            return "Caso 48 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
