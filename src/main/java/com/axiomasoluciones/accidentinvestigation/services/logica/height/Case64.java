...
public class Case64 {
    public String case64(Event event) {
        ...
        if (
            ...
            return "Caso 64 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
