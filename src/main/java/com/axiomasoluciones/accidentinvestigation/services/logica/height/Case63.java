...
public class Case63 {
    ...
    public String case63(Event event) {
        ...
        if (
            ...
            return "Caso 63 TRABAJO EN ALTURA  habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
