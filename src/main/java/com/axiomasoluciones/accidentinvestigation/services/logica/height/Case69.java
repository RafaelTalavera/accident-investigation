...
public class Case69 {
    ...
    public String case69(Event event) {
        ...
        if (
            ...
            return "Caso 69 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
