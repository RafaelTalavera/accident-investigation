...
public class Case78 {
    ...
    public String case78(Event event) {
        ...
        if (
            ...
            return "Caso 78 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
