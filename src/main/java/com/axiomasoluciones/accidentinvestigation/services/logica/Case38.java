...
public class Case38 {
    ...
    public String case38(Event event) {
        ...
        if (
            ...
            return "Caso 38 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
