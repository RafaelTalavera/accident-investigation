...
public class Case49 {
    ...
    public String case49(Event event) {
        ...
        if (
            ...
            return "Caso 49 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
