...
public class Case25 {
    ...
    public String case25(Event event) {
        ...
        if (
            ...
            return "Caso 25 TRABAJO EN ALTURA  habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
