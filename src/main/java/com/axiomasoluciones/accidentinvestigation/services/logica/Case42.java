...
public class Case42 {
    ...
    public String case42(Event event) {
        ...
        if (
            ...
            return "Caso 42 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
