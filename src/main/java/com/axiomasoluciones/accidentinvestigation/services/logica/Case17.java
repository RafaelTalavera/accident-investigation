...
public class Case17 {
    ...
    public String case17(Event event) {
        ...
        if (
            ...
            return "Caso 17 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
