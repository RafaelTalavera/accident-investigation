...
public class Case76 {
    ...
    public String case76(Event event) {
        ...
        if (
            ...
            return "Caso 76 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
