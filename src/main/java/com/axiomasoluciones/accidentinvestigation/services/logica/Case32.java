...
public class Case32 {
    ...
    public String case32(Event event) {
        ...
        if (
            ...
            return "Caso 32 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
