...
public class Case30 {
    ...
    public String case30(Event event) {
        ...
        if (
            ...
            return "Caso 30 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
