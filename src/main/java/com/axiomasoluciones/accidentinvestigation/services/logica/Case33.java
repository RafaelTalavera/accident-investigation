...
public class Case33 {
    ...
    public String case33(Event event) {
        ...
        if (
            ...
            return "Caso 33 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
