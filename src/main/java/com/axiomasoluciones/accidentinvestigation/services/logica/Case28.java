...
import static com.axiomasoluciones.accidentinvestigation.models.entity.util.persistencia.Weather.ALTA_TEMPERATURA;
...
public class Case28 {
    ...
    public String case28(Event event) {
        ...
        if (
            ...
            return "Caso 28 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
