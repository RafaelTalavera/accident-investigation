...
public class Case75 {
    ...
    public String case75(Event event) {
        ...
        if (
            ...
            return "Caso 75 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
