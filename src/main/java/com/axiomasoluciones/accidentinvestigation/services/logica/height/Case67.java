...
public class Case67 {
    ...
    public String case67(Event event) {
        ...
        if (
            ...
            return "Caso 67 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
