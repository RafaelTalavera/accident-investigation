...
import static com.axiomasoluciones.accidentinvestigation.models.entity.util.Weather.NUBOSIDAD_ALTA;
import static com.axiomasoluciones.accidentinvestigation.models.entity.util.Weather.PRECIPITACION;
import static com.axiomasoluciones.accidentinvestigation.models.entity.util.WorkOccasion.TAREAS_PROPIAS_RUTINA;

public class Case21 {

    public String case21(Event event) {
        ...
        if (
            //habilidades entrenamiento bajo
                ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) < 6
                        ...
                        && event.getWorkPlace().getWeather().equals(NUBOSIDAD_ALTA)
            ...
            return "Caso 21 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
