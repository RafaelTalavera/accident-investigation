...
public class Case22 {
    ...
    public String case22(Event event) {
        ...
        if (
            ...
            return "Caso 22 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
