...
public class Case44 {
    ...
    public String case44(Event event) {
        ...
        if (
            ...
            return "Caso 44 TRABAJO EN ALTURA  habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
