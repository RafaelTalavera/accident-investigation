...
public class Case37 {
    ...
    public String case37(Event event) {
        ...
        if (
            ...
            return "Caso 37 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
