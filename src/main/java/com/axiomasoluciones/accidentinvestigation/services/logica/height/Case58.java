...
public class Case58 {
    ...
    public String case58(Event event) {
        ...
        if (
            ...
            return "Caso 58 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
