...
public class Case14 {
    ...
    public String case14(Event event) {
        ...
        if (
            ...
            return "Caso 14 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
