...
public class Case1AntiMeSeisTenFiBaja {
    ...
    public String case1(Event event) {
        ...
        if (
            ...
            return "habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
                    " de antiguedad "  ;
        }
