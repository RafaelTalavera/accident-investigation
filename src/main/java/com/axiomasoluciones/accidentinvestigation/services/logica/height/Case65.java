...
public class Case65 {
    public String case65(Event event) {
        ...
        if (
            ...
            return "Caso 65 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
