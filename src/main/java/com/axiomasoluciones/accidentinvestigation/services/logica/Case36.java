...
public class Case36 {
    ...
    public String case36(Event event) {
        ...
        if (
            ...
            return "Caso 36 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
