...
public class Case66 {
    ...
    public String case66(Event event) {
        ...
        if (
            ...
            return "Caso 66 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
