...
public class Case15 {
    ...
    public String case15(Event event) {
        ...
        if (
            ...
            return "Caso 15 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
