...
public class Case55 {
    ...
    public String case55(Event event) {
        ...
        if (
            ...
            return "Caso 55 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
