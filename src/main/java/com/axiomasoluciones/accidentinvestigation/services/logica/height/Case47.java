...
public class Case47 {
    ...
    public String case47(Event event) {
        ...
        if (
            ...
            return "Caso 47 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
