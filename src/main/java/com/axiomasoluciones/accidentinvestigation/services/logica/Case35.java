...
public class Case35 {
    ...
    public String case35(Event event) {
        ...
        if (
            ...
            return "Caso 35 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
