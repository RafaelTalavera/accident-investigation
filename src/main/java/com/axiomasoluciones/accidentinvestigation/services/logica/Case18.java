...
import static com.axiomasoluciones.accidentinvestigation.models.entity.util.Weather.TORMENTA;
import static com.axiomasoluciones.accidentinvestigation.models.entity.util.Weather.VIENTO;
import static com.axiomasoluciones.accidentinvestigation.models.entity.util.WorkOccasion.TAREAS_PROPIAS_RUTINA;

public class Case18 {

    public String case18(Event event) {
        ...
        if (
            //habilidades entrenamiento bajo
                ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) < 6
                        ...
                        && event.getWorkPlace().getWeather().equals(VIENTO)
            ...
            return "Caso 18 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
