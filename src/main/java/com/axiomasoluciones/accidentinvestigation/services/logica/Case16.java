...
public class Case16 {
    ...
    public String case16(Event event) {
        ...
        if (
            ...
            return "Caso 16 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
