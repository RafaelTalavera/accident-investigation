...
public class Case60 {
    ...
    public String case60(Event event) {
        ...
        if (
            ...
            return "Caso 60 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
