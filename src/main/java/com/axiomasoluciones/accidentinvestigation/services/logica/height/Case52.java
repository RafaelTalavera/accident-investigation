...
import static com.axiomasoluciones.accidentinvestigation.models.entity.util.persistencia.Weather.NORMAL;
...
public class Case52 {
    ...
    public String case52(Event event) {
        ...
        if (
            //habilidades entrenamiento bajo
                ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) < 6
                        ...
                        && event.getWorkPlace().getWeather().equals(NORMAL)
            ...
            return "Caso 52 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
