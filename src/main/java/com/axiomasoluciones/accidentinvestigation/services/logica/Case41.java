...
public class Case41 {
    ...
    public String case41(Event event) {
        ...
        if (
            ...
            return "Caso 41 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
