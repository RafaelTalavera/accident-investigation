...
import static com.axiomasoluciones.accidentinvestigation.models.entity.util.Weather.GRANIZO;
import static com.axiomasoluciones.accidentinvestigation.models.entity.util.WorkOccasion.TAREAS_PROPIAS_RUTINA;

public class Case19 {

    public String case19(Event event) {
        ...
        if (
            ...
            return "Caso 19 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
