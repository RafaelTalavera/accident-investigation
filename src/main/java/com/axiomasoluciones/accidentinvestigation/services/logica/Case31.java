...
public class Case31 {
    ...
    public String case31(Event event) {
        ...
        if (
            ...
            return "Caso 31 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
