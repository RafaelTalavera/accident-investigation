...
public class Case34 {
    ...
    public String case34(Event event) {
        ...
        if (
            ...
            return "Caso 34 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
