...
public class Case80 {
    ...
    public String case80(Event event) {
        ...
        if (
            ...
            return "Caso 80 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
