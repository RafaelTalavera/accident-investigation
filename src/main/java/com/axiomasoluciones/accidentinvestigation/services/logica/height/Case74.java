...
public class Case74 {
    ...
    public String case74(Event event) {
        ...
        if (
            ...
            return "Caso 74 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
