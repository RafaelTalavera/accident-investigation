...
public class Case45 {
    public String case45(Event event) {
        ...
        if (
            ...
            return "Caso 45 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
