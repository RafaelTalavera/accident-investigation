...
public class Case77 {
    ...
    public String case77(Event event) {
        ...
        if (
            ...
            return "Caso 77 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
