...
public class Case68 {
    ...
    public String case68(Event event) {
        ...
        if (
            ...
            return "Caso 68 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
