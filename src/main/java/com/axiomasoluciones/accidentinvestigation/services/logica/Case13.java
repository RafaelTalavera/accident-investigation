...
public class Case13 {
    ...
    public String case13(Event event) {
        ...
        if (
            ...
            return "Caso 13 TRABAJO EN ALTURA: habilidades/entrenamiento Baja: La persona tiene: " + ChronoUnit.MONTHS.between(event.getWorker().getEntry(), currentDate) +
